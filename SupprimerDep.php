...
<head>
    ...
    <title>Suppression Departements</title>
    <style type="text/css">
    .gray {
        width: 100%;
        min-height: 100vh; 
...
<body>
    <section class="gray">
        <section><strong><h1>Suppression des Departements</h1></strong> 
...
if(isset($_POST['effacer'])){
    ...
    $code=$sql=$bd->prepare("DELETE FROM departement WHERE IdDep=? " ) ;
    $ex=$code->execute(array($Id)) ;

    if($result){
    echo 'suppression reussie' ;
    Header('locaton:Depart.php') ;
    } else {
