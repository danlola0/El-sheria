...
<body>
    <section class="gray">
        <section><strong><h1>Modification des Utilisateurs</h1></strong> 
...
$code=$bd->prepare("UPDATE Utilisateur SET nom=? , postnom=? , gmail=? , fonction=? , password=? WHERE IdUtil=$Id");
$ex=$code->execute(array($nom,$postnom,$gmail,$fonction,$password));
if($ex){
