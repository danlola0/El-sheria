        ...
        <div class="details">
            <div class="recentOrders">
                ...
                <table>
                    ...
                    ?>
                        ...
                        <td><?php echo $index; ?> </td>
                            ...
                            <td>
                                <a href="SupprimerProf.php?IdProf=<?php echo $row['IdProf']; ?>" class="Sup">
                                    <ion-icon class="bi bi-trash"></ion-icon>
                                </a>
                                <a href="ModifierProf.php?IdProf=<?php echo $row['IdProf']; ?>" class="Mod">
                ...
                <div class="inputboite">
                    <a href="FormProf.php" class="btn2"><ion-icon class="bi bi-person-plus"></ion-icon></a>
                </div> 
            </div>
