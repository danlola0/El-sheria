...
<head>
    ...
    <title>Suppression Chefs des Travaux</title>
    <style type="text/css">
    .gray {
        width: 100%;
        min-height: 100vh; 
...
<body>
    <section class="gray">
        <section><strong><h1>Suppression des Chef de Travaux</h1></strong> 
...
if(isset($_POST['effacer'])){
    ...
    $code=$sql=$bd->prepare("DELETE FROM ct WHERE IdCt=? " ) ;
    $ex=$code->execute(array($Id)) ;

    if($result){
    echo 'suppression reussie' ;
    Header('locaton :CT.php') ;
    } else {
