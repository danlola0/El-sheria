        ...
        <div class="details">
            <div class="recentOrders">
                ...
                <table>
                    ...
                    $sql=$bd->query('SELECT * from utilisateur');
                    $index=1;
                    while($aff=$sql->fetch()){?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>   
                                <a href="SupprimerUtil.php?IdUtil=<?php echo $aff['IdUtil']; ?>" class="Sup"><ion-icon class="bi bi-trash"></ion-icon></a> 
                                <a href="ModifierUtil.php?IdUtil=<?php echo $aff['IdUtil']; ?>" class="Mod"><ion-icon class="bi bi-file-plus"></ion-icon></a> 
                            </td>
                ...
                <div class="inputboite">
                    <a href="FormUtil.php" class="btn2"><ion-icon class="bi bi-person-plus"></ion-icon></a>
                </div> 
            </div>
