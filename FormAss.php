...
$sql=$bd->prepare("INSERT INTO ass (Nom, Postnom, Prenom, Email, Tel, Sexe, Article, Date, Pdf, FKIdDep, FKIdProf) VALUES (:Nom, :Postnom, :Prenom, :Email, :Tel, :Sexe, :Article, :Date, :Pdf, :FKIdDep, :FKIdProf)");
...
$selectProfPublication=$bd->query("SELECT * FROM ass ORDER BY IdAss DESC");
$result2=$selectProfPublication->fetch();
    while ($result=$sql1->fetch()) {
        ...
        $insert_notification->execute(array($result['IdCon'],$result2['IdAss'],'ass'));
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Formulaire Assistant(e)s</title>
    <style type="text/css">
    .gray {
        width: 100%;
        min-height: 100vh; 
...
<body>
    <section class="gray">
        <section><strong><h1>Formulaire des Assistant(e)s</h1></strong> 
            <form id="monForm" action="" method="post">
                <fieldset>
                    <legend id="cont"><strong>Assistant(e)s</strong></legend><br/>
                    <table>
                        <tbody>
                            <tr> 
                                <td><label for="Nom"><strong>Nom: </strong></label></td>
                                <td><input id="Nom" name="Nom" type="text" class="un" required="required" placeholder="Votre nom" autofocus oninput="validation_Element(this)" /></td>
                            </tr>
                            <tr> 
                                <td><label for="Postnom"><strong>Postnom: </strong></label></td>
                                <td><input  name="Postnom"  id="Postnom" type="text" class="un" required="required" placeholder="Votre postnom" /></td>
                            </tr>
                            <tr>
                                <td><label for="Prénom"><strong>Prenom: </strong></label></td>
                                <td><input name="Prenom" id="Prénom" type="text" class="un" required="required" placeholder="Votre prenom" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr> 
                                ...
                                <td> <input id="Tél" name="Tel" type="Tél" class="un" placeholder="+243" pattern="{13}" /></td>
                            </tr>
                            <tr> 
                            ...
                            <tr>
                                ...
                                <td><textarea name="Article" id="TextArea1" class="un" name="Article" cols="20" rows="2"></textarea></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input name="FKIdProf"  id="Professeur" class="un" name="FKIdProf" value="0" type="number" min="0" max="10" /></td>
                            </tr>
                            <tr>
                                <td><label for="Formation"><strong>Departement: </strong></label></td>
                                <td><input name="FKIdDep"  id="Departement" class="un" name="FKIdDep" value="0" type="number" min="0" max="6" /></td>
                            </tr>
                        </tbody>
                    </table>
                </fieldset>
                ...
                <tr>
                    <td>
                        ...
                        <a href="Ass.php" class="lien"><ion-icon class="bi bi-reply-all"></ion-icon></a>
