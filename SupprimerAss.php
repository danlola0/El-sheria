...
<head>
    ...
    <title>Suppression Assistant(e)s</title>
    <style type="text/css">
    .gray {
        width: 100%;
        min-height: 100vh; 
...
<body>
    <section class="gray">
        <section><strong><h1>Suppression des Assistant(e)s</h1></strong> 
...
if(isset($_POST['effacer'])){
    ...
    $code=$sql=$bd->prepare("DELETE FROM ass WHERE IdAss=? " ) ;
    $ex=$code->execute(array($Id)) ;

    if($result){
    echo 'suppression reussie' ;
    Header('locaton :Ass.php') ;
    } else {
