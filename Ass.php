        ...
        <div class="details">
            <div class="recentOrders">
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="SupprimerAss.php?IdAss=<?php echo $row['IdAss']; ?>" class="Sup">
                                    <ion-icon class="bi bi-trash"></ion-icon>
                                </a>
                                <a href="ModifierAss.php?IdAss=<?php echo $row['IdAss']; ?>" class="Mod">
                ...
                <div class="inputboite">
                    <a href="FormAss.php" class="btn2"><ion-icon class="bi bi-person-plus"></ion-icon></a>
                </div> 
            </div>
        </div>
    </div>
