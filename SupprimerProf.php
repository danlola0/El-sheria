...
<head>
    ...
    <title>Suppression Professeurs</title>
    <style type="text/css">
    .gray {
        width: 100%;
        min-height: 100vh; 
...
<body>
    <section class="gray">
        <section><strong><h1>Suppression des Professeurs</h1></strong> 
...
if(isset($_POST['effacer'])){
    ...
    $code=$sql=$bd->prepare("DELETE FROM professeur WHERE IdProf=? " ) ;
    $ex=$code->execute(array($Id)) ;

    if($result){
    echo 'suppression reussie' ;
    Header('locaton :Professeur.php') ;
    } else {
