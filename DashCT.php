...
if($count2Fast>0){
    while($take_notification=$sql2Fast->fetch()){
        $update= $con->prepare("UPDATE notification SET state ='off' WHERE type='ct' AND idCon='".$_SESSION['id']."'");
        $update->execute();
    }
    $count2Fast=0;
}
...
<li>
                    <a href="DashProf.php" id="messages-notification">
            ...
            <div class="dash-content">
                <div class="activity">
                    <div class="title">
                        ...
                        <span class="text">Récentes Publications de Chef des travaux</span>
                    </div>
                    <div class="activity-data">
                        <table>
                            ...
                            <?php
                                ...
                                //7275-1738-6252-5378-323
                                $index=1;
                                if ($result->num_rows > 0) {
                                 while ($row = $result->fetch_assoc()) {
                                $file_path = "uploads/" . $row['CT_Pdf'];
                            ?> 
                            <tbody>
                                <tr class="message">
                                    <td><span class="data-list"><?php echo $index; ?></span></td>
                                    <td><span class="data-list"><e><?php echo $row['CT_Nom']; ?></e></span></td>
                                    <td><span class="data-list"><?php echo $row['CT_Email']; ?></span></td>
                                    <td><span class="data-list"><?php echo $row['CT_Article']; ?></span></td>
                                    <td><span class="data-list"><?php echo $row['CT_Date']; ?></span></td>
