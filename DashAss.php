...
if($count3Fast>0){
    while($take_notification=$sql3Fast->fetch()){
        $update= $con->prepare("UPDATE notification SET state ='off' WHERE type='ass' AND idCon='".$_SESSION['id']."'");
        $update->execute();
    }
    $count3Fast=0;
}
            ...
            <div class="dash-content">
                <div class="activity">
                    <div class="title">
                        ...
                        <span class="text">Récentes Publications des Assistant(e)s</span>
                    </div>
                    <div class="activity-data">
                        <table>
                            ...
                            <?php
                                ...
                                $file_path = "uploads/" . $row['Ass_Pdf'];
                            ?> 
                            <tbody>
                                <tr class="message">
                                    <td><span class="data-list"><?php echo $index; ?></span></td>
                                    <td><span class="data-list"><e><?php echo $row['Ass_Nom']; ?></e></span></td>
                                    <td><span class="data-list"><?php echo $row['Ass_Email']; ?></span></td>
                                    <td><span class="data-list"><?php echo $row['Ass_Article']; ?></span></td>
                                    <td><span class="data-list"><?php echo $row['Ass_Date']; ?></span></td>
